<x-dropdown >
    ...
    <x-slot name="trigger">
{{-- TRIGGER  --}}
        <button class="text-black py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32 text-left flex lg:inline-flex">
        
        {{ isset($currentCategory) ? ucwords($currentCategory->name) : 'Categories' }}

        {{-- <x-down-arrow class="absolute pointer-events-none" style="right: 12px;"/> --}}
        <x-icon name="down-arrow" class="text-black absolute pointer-events-none" style="right: 12px;"/>
